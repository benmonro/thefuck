...
from therandy.shells import Fish
...
class TestFish(object):
    ...
    def Popen(self, mocker):
        mock = mocker.patch('therandy.shells.fish.Popen')
    ...
    def test_app_alias(self, shell):
        ...
        assert ARGUMENT_PLACEHOLDER in shell.app_alias('randy')
    ...
    def test_put_to_history(self, entry, entry_utf8, builtins_open, mocker, shell):
        mocker.patch('therandy.shells.fish.time', return_value=1430707243.3517463)
