...
import pytest
from therandy.shells.tcsh import Tcsh
...
class TestTcsh(object):
    ...
    def Popen(self, mocker):
        mock = mocker.patch('therandy.shells.tcsh.Popen')
        mock.return_value.stdout.read.return_value = (
            b'randy\teval $(therandy $(fc -ln -1))\n'
            b'l\tls -CF\n'
            b'la\tls -A\n'
            b'll\tls -alF')
        return mock
    ...
    def test_get_aliases(self, shell):
        assert shell.get_aliases() == {'randy': 'eval $(therandy $(fc -ln -1))',
                                       'l': 'ls -CF',
                                       'la': 'ls -A',
                                       'll': 'ls -alF'}

    def test_app_alias(self, shell):
        assert 'setenv TF_SHELL tcsh' in shell.app_alias('randy')
