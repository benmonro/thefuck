...
import pytest
from therandy.rules.port_already_in_use import match, get_new_command
...
Traceback (most recent call last):
  ...
  File "/home/benmonro/exp/code_view/server/code_view/main.py", line 14, in <module>
    web.run_app(app)
  File "/home/benmonro/.virtualenvs/code_view/lib/python3.5/site-packages/aiohttp/web.py", line 310, in run_app
    backlog=backlog))
...
task: <Task pending coro=<RedisProtocol._reader_coroutine() running at /home/benmonro/.virtualenvs/code_view/lib/python3.5/site-packages/asyncio_redis/protocol.py:921> wait_for=<Future pending cb=[Task._wakeup()]>>
    '''
]

lsof_stdout = b'''COMMAND   PID USER   FD   TYPE DEVICE SIZE/OFF NODE NAME
node    18233 benmonro   16u  IPv4 557134      0t0  TCP localhost:http-alt (LISTEN)
'''


@pytest.fixture(autouse=True)
def lsof(mocker):
    patch = mocker.patch('therandy.rules.port_already_in_use.Popen')
