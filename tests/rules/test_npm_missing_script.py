...
from therandy.rules.npm_missing_script import match, get_new_command
...
npm ERR!     /home/benmonro/exp/code_view/client_web/npm-debug.log
'''.format
...
def run_script(mocker):
    patch = mocker.patch('therandy.specific.npm.Popen')
