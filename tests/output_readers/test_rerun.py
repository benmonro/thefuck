...
from therandy.output_readers import rerun


class TestRerun(object):
    def setup_method(self, test_method):
        self.patcher = patch('therandy.output_readers.rerun.Process')
    ...
    @patch('therandy.output_readers.rerun._wait_output', return_value=False)
    @patch('therandy.output_readers.rerun.Popen')
    ...
    @patch('therandy.output_readers.rerun._kill_process')
    ...
    @patch('therandy.output_readers.rerun.logs')
