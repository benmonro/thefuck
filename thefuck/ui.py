...
class CommandSelector(object):
    ...
    def __init__(self, commands):
        """:type commands: Iterable[therandy.types.CorrectedCommand]"""
    ...
    @property
    def value(self):
        """:rtype therandy.types.CorrectedCommand"""
...
def select_command(corrected_commands):
    ...
    :type corrected_commands: Iterable[therandy.types.CorrectedCommand]
    :rtype: therandy.types.CorrectedCommand | None

    """
    try:
        selector = CommandSelector(corrected_commands)
    except NoRuleMatched:
        logs.failed('No randys given' if get_alias() == 'randy'
                    else 'Nothing found')
        return
